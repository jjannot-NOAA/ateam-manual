...
----
![](/_img/NOAA_Fisheries_image.png)

NOAA Fisheries monitors the health and sustainability of fish, marine mammals, and their habitats across nearly 1.5 million square miles of water surrounding the state, which produces more than half of the fish caught in the United States, worth \$1.8 billion.
...
## NOTE: This section is still being developed with the help of all Program Staff.
...
[NOAA's Mission](https://www.noaa.gov/our-mission-and-vision) statement also includes **science**.
...
Science[^the-big-picture-1] from the FMA A-Team:

[^the-big-picture-1]: Scientific products might include (but is not limited to) data, data products, software, web applications, summaries, reports, analyses, models, presentations and advice.\
