...
## Intake & Prioritization
 ...
 Prioritization includes several dimensions including (but not limited to) how well the project's goals and objectives align with NOAA Fisheries, AFSC, and FMA priorities and activities which are described in Annual Guidance Memos (NMFS), Strategic Plans (AFSC), and Activity Plans (FMA).  Links to these documents can be found on the [Resources](09-resources.qmd#sec-resources) page of this manual.  In addition to strategic priorities, prioritization of projects also takes into account the following (higher scores = higher priority):    
