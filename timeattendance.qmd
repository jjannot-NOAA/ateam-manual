...
The new DOC telework policy can be used now by non-bargaining unit employees. The union has bargaining rights for Impact and Implementation which is currently (`{r} today`) being negotiated.
 
<!--1. You are currently (`{r} today`) required to be in the office 2 days per pay period.    
