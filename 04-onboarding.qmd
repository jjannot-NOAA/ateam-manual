...
##### Credit Hours
 If you are on a Maxi-Flex schedule, Credit Hours can be claimed *in lieu* of overtime pay (see below). Guidelines:
...
##### Compensatory Time
Compensatory time can be awarded for **travel** that occurs outside or beyond normal working hours or days.
