...
1. You are currently (`r Sys.Date()`) required to be in the office 2 days per week.    
...
More details can be found in the [Observer Training appendix](999-observer-training-classes.qmd), but check with the Program Manager or the FMA Training Program Manager for the most up-to-date schedule.
...
* 1057 - XXXX XXXXX, Data Management Specialist, PSMFC
* 1057 - XXXX XXXXX, Research Fishery Biologist, NOAA
